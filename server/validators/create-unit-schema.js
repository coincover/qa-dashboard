...
const DATE_REGEX = /^([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01])_(0\d|1\d|2[0-3]):([0-5]\d):([0-5]\d))$/;

const createUnitSchema = yup
  .object({
    date: yup.string().matches(DATE_REGEX, 'date must be in the format YYYY-MM-DD_HH:MM:SS'),
